...
def main():
    ...
    # raws = ["D:/Computer Science/Github/Palmprint-Segmentation/cv_segment/pics/canny2.jpg"]

    segnet = SegNet(raws, labels, raws_test, labels_test, start_step=5400, batch_size=1, epoch_size=600, input_size=128)
